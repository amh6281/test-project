...
const HistoryListItem = ({
  ...
  return (
    <button
      type='button'
      onClick={onClick}
      className='w-full px-4 py-4 text-left transition hover:bg-slate-50 active:bg-slate-100 dark:hover:bg-slate-800 dark:active:bg-slate-700 sm:px-6'
    ...
    >
      <div className='flex items-center justify-between gap-4'>
        ...
        <div className='cursor-pointer text-slate-400 dark:text-slate-500'>
          <svg
            className='h-5 w-5'
            fill='none'
            stroke='currentColor'
